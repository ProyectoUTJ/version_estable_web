...
$sql = "SELECT b.consumo ,a.placas from vehiculo a 
        inner join consumo b on a.id_vehiculo=b.vehiculo 
        where a.empresa=2 and a.Tipcombustible='gasolina' ORDER BY b.id_consumo desc ";
...
var layout = {
  title: 'Reporte de consumo de gasolina',
  xaxis: {tickfont: {
      size: 14,
...
Plotly.newPlot('consumog', data, layout);
