          ...
          <div class="col-md-12">
            ...
            <div class="card card-user">
              ...
              <div class="card-body">
                ...
                <form action="crud/editauto.php" method="PUT">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        ...
                        <input style="text-align:center;" name="marca" type="text" class="form-control" value="<?php echo $marca;?>">
                      </div>
                    </div>
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        <label>Año</label>
                        <input style="text-align:center;" name="age" type="text" class="form-control" value="<?php echo $age;?>">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Placas</label>
                        <input style="text-align:center;" name="placas" type="text" class="form-control" value="<?php echo $placas;?>">
                      </div>
                    </div>
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        <label>Capacidad de combustible</label>
                        <input style="text-align:center;" name="Capcombustible" type="text" class="form-control" value="<?php echo $Capcombustible;?>">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input style="text-align:center;" name="kilometraje" type="text" class="form-control" value="<?php echo $kilometraje;?>">
                      </div>
                    </div>
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
